...
class IdentificationTypeRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(IdentificationType $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(IdentificationType $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return IdentificationType[] Returns an array of IdentificationType objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?IdentificationType
    {
        return $this->createQueryBuilder('i')
            ->andWhere('i.exampleField = :val')
            ->setParameter('val', $value)
